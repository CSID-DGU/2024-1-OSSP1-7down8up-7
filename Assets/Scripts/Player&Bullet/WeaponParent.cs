...
public class WeaponParent : MonoBehaviour
{
    ...
    public AudioClip gunshotClip; // 총소리 효과음
    ...
    private void InitializeBulletPool(int poolSize)
    {
        ...
        {
            GameObject obj = Instantiate(bulletPrefab, GameObject.Find("GameManager").transform);
            obj.SetActive(false);
            bulletPool.Add(obj);
        }
    }
    ...
    private GameObject GetPooledBullet()
    {
        ...
        GameObject newBullet = Instantiate(bulletPrefab, GameObject.Find("GameManager").transform);
